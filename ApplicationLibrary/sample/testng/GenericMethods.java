...
public class GenericMethods extends PropertiesFileReader {
	...
	public static void dataSourceDetails(String dsName,String dsHost,String dsPort,String dsUsername,String dsPassword) throws InterruptedException {
		enterText(com.pageobjects.CreateDatasouce.dsName, dsName+ getCurrentTimeInstance());
		String text =driver.findElement(By.xpath(com.pageobjects.CreateDatasouce.dsName)).getAttribute("value");
		System.out.println(text);
		enterText(com.pageobjects.CreateDatasouce.dsHost, dsHost);
		enterText(com.pageobjects.CreateDatasouce.dsPort, dsPort);
	...
	public static void datasourceSavePopups() {
		...
		if(actualPopupText.contains(expectedPopupText)) {
			buttonClick(com.pageobjects.CreateDatasouce.popupOkBtn);
			driver.switchTo().activeElement();
			waitForElement(By.xpath(com.pageobjects.CreateDatasouce.popup));
			String actualPopuText1= driver.findElement(By.xpath(com.pageobjects.CreateDatasouce.popup)).getText();		
			String expectedPopupText1 ="DataSource Connection saved successfully.";
			if(actualPopuText1.contains(expectedPopupText1)) {
				buttonClick(com.pageobjects.CreateDatasouce.popupOkBtn1);
			...
			String actualPopuText2= driver.findElement(By.xpath(com.pageobjects.CreateDatasouce.popup)).getText();	
	...
	public List<String> getValuesFromApp() throws InterruptedException {
		...
		Thread.sleep(propertyFileReader.getImplicitlyWait());
		GenericMethods.enterText(com.objects.LoginPageElements.username, propertyFileReader.getUserName());
		GenericMethods.enterText(com.objects.LoginPageElements.password, propertyFileReader.getPassword());
		GenericMethods.buttonClick(com.objects.LoginPageElements.loginBtn);
		Thread.sleep(propertyFileReader.getImplicitlyWait());
		List<String> values = new ArrayList<String>();
		Thread.sleep(propertyFileReader.getImplicitlyWait());
		GenericMethods.buttonClick(com.objects.HomePageElements.connectLink);
		Thread.sleep(propertyFileReader.getImplicitlyWait());
		GenericMethods.buttonClick(com.objects.HomePageElements.viewDsLink);
		Thread.sleep(propertyFileReader.getImplicitlyWait());
	//	GenericMethods.buttonClick(com.objects.HomePageElements.navigateToGrid);
		Thread.sleep(propertyFileReader.getImplicitlyWait());
